...
void AnimationManager::AddMap(const std::unordered_map<std::string, AnimetionClip::Animation>& animation, const std::string& name) {
...
AnimetionClip::Animation AnimationManager::GetAnimation(const std::string& animationFile, const std::string& animationName) {
